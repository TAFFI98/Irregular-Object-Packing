...
if __name__ == '__main__':
    ...
    parser.add_argument('--epsilon', action='store', default=0.955)           # Valore iniziale per epsilon
    parser.add_argument('--epsilon_min', action='store', default=0.05)      # Valore minimo per epsilon
    parser.add_argument('--epsilon_decay', action='store', default=0.99875)   # Fattore di decrescita per epsilon
    ...
    parser.add_argument('--sample_counter_threshold', action='store', default=2)        #
